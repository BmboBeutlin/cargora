  ...
  create(): void {
    ...
    for (let y = 0; y < MAP_H; y++) {
      for (let x = 0; x < MAP_W; x++) {
        ...
        tile.setStrokeStyle(1, info.edgeColor, 0.55);
        tile.setDepth(sy);
      }
    }
